...
/**
 * This Class is a Table in database and is used for identify AdminUsers of the app
 */
...
public class PremiumUser implements User {
     ...
     * @param tip int
     */
    public PremiumUser(String username, String email, String parola, String adresa, int tip) {
